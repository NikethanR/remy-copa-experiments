...
#mm-delay 10 mm-link /home/ubuntu/traces/trace-32Mbps /home/ubuntu/traces/trace-32Mbps --uplink-queue=droptail --uplink-queue-args=bytes=60000
...
if [[ $1 == "run" ]]; then
    ...
    for tcp in "copa" "vegas"; do # "cubic" "reno" "pcc" "bbr" "vegas"; do
        ...
        for (( i=0; i < $num_flows; i++ )); do
            ...
            if [[ $tcp == "cubic" ]] || [[ $tcp == "reno" ]] || [[ $tcp == "vegas" ]]; then
                ...
                su -c "./run-bbr-sender \"iperf -c $receiver_ip -t $onduration -Z bbr -p 5001 \" ingress /tmp/experiment-dynamic-bbr.log &" ubuntu
